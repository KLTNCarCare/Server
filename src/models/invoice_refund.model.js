...
invoiceRefundSchema.virtual("sub_total").get(function () {
...
invoiceRefundSchema.virtual("final_total").get(function () {
...
invoiceRefundSchema.pre(["findOneAndUpdate", "updateOne"], function (next) {
